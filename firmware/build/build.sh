...
TARGET="$BUILD_DIR/buscomm${TARGET_SUFFIX:-}"
...
find "$BUILD_DIR" -maxdepth 1 -type f \( -name 'buscomm*.elf' -o -name 'buscomm*.bin' \
  -o -name 'buscomm*.hex' -o -name 'buscomm*.map' \) -delete
